...
\title{\textbf{Аналитическая справка} \\ по файлу \texttt{image\_stitching.ipynb}}
\author{}
\date{}
...
\section{Назначение}
Jupyter-ноутбук посвящён \textbf{сшивке двух изображений} (image stitching) с использованием библиотеки OpenCV.
...
\hline
Конвертация в оттенки серого & \texttt{cv2.cvtColor(..., COLOR\_BGR2GRAY)} \\
\hline
...
\hline
Фильтрация хороших совпадений & Тест Лоу (отношение расстояний $< 0.75$) \\
\hline
...
\subsection{Гомография}
Матрица гомографии $H$ размером $3 \times 3$ описывает проективное преобразование между двумя плоскостями:
...
где $(x, y)$ — координаты точки на первом изображении, $(x', y')$ — соответствующие координаты на втором изображении.

\subsection{Тест Лоу}
Для фильтрации совпадений используется отношение расстояний до ближайшего и второго ближайшего соседа:
